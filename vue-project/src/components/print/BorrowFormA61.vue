  ...
  >
    <header class="mb-[4mm]">
      <div class="mb-[2mm] flex items-start gap-[4mm]">
        <div
          class="grid h-[18mm] w-[18mm] shrink-0 place-items-center border border-black text-[9px]"
        >
          LOGO
        </div>
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="mt-[2mm] text-[14px] leading-[1.55]">
            <div class="flex items-baseline gap-[2mm]">
              ...
              <span
                class="min-w-0 flex-1 border-b border-dotted border-black px-[1mm] pb-[0.5mm]"
              >
    ...
    <section class="print:break-inside-avoid">
      ...
      <table class="w-full table-fixed border-collapse">
        ...
        <tbody>
          <tr
            v-for="(asset, index) in rows"
            :key="asset?.id || asset?.assetCode || `blank-${index}`"
          >
